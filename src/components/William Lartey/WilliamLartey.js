...
import styles from "./WilliamLartey.module.scss";
      ...
      case 0:
        return (
          <motion.video
            ...
            muted={muted}
          >
            <source src="https://i.imgur.com/2UsEhqw.mp4" />
        ...
        return (
          ...
          >
            <Video
              ...
              poster="https://i.imgur.com/1zEauxk.png"
              onCanPlayThrough={() => {
                // Do stuff
              }}
            >
              <source src="https://i.imgur.com/2UsEhqw.mp4" type="video/webm" />
              <track
                label="English"
                kind="subtitles"
                srcLang="en"
